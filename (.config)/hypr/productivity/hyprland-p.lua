...
hl.env("HQS_DIR", os.getenv("HOME") .. "/Pictures/Screenshots")
...
-- Always On Window Rules
	  hl.window_rule({ match = { class = "org.gnome.Nautilus"}, opacity = "0.95 0.95" })

-- Single Monitor Window Rules
   -- hl.window_rule({ match = { class = "Zed" }, workspace = "1 silent", })
   -- hl.window_rule({ match = { class = "Github Desktop" }, workspace = "1 silent", })
